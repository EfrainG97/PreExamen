...
namespace PreExamen.Model.DSUniversidadTableAdapters {
    ...
    public partial class alumnosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PreExamen.Properties.Settings.Default.universidad2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT alumnos.*\r\nFROM     alumnos";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "UPDATE `alumnos` SET `Nombre` = @Nombre, `Apellido` = @Apellido, `FechaNacimiento" +
                "` = @FechaNacimiento, `Correo` = @Correo WHERE (`AlumnoID` = @AlumnoID)";
            ...
            this._commandCollection[2].CommandText = "DELETE FROM `alumnos` WHERE (`AlumnoID` = @AlumnoID)";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO `alumnos` (`Nombre`, `Apellido`, `FechaNacimiento`, `Correo`) VALUES " +
        ...
        public virtual int ActualizarAlumno(string Nombre, string Apellido, string FechaNacimiento, string Correo, int AlumnoID) {
        ...
        public virtual int EliminarAlumno(int AlumnoID) {
        ...
        public virtual int InsertarAlumno(string Nombre, string Apellido, string FechaNacimiento, string Correo) {
